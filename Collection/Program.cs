    ...
    internal class Program
    {
        static void Main(string[] args)
        {
           var collection = new Collection<int>();
            ...
            Console.WriteLine("Collection count: " + collection);
            ...
            Console.WriteLine("Print the first element: " + collection);

            collection[1] = 18;
            Console.WriteLine("Print the first element: " + collection[1]);
